...
function displayDescription(predictions) {
  ...
  if (result.probability > 0.2) {
    ...
    console.log(`${probability}% shure this is a ${result.className.replace(
        ",",
        " or")}🐶`)
    // Display result
    description.innerHTML = `${probability}% shure this is a ${result.className.replace(
      ",",
      " or"
    )} 🐶`;
  } else description.innerHTML = "I am not shure what I should recognize 😢";
}
